...
# install pip deps
pip install numpy scipy scikit-learn scikit-image opencv-python pyassimp  h5py tensorflow mayavi matplotlib catkin_pkg multiprocess dill cvxopt ipython pillow pyhull setproctitle trimesh
